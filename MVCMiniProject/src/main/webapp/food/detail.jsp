	...
	<div class="wrapper row3">
		<main class="container clear">
			...
			<tr>
				...
				<a href="#"class="btn btn-xs btn-info">찜</a> 
			...
			<div class="flexslider carousel basiccarousel btmspace-80">
				<ul class="slides">
					<c:forEach var="svo" items="${sList }">
						<li>
							<figure>
								<img class="radius-10 btmspace-10" title="${svo.address }"
									src="${svo.poster }" style="width: 320px; height: 185px">
								<figcaption>
									<a href="#">${svo.name }</a>
								</figcaption>
							</figure>
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ad1118e53987d68aee665bda359d26ac&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
